...
import customoperators.FilterAnimalByStatusOp;
import customoperators.RelationToStreamAnimalOp;
...
public class AnimalStepByStepGuide1 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        DataStream<Animal> inputStreamAnimal = generator.getStream("animal_market_one");
        ...
        //Define Relation to Relation operators and chain them together. Here we filter out animals that are sick
        RelationToRelationOperator<AnimalBasket> r2r_filter_sick = new FilterAnimalByStatusOp("sick", Collections.singletonList(animal_s2r_one.getName()), "filtered_animal");
        ...
        task = task.addS2ROperator(animal_s2r_one, inputStreamAnimal)
        ...
        inputStreams.add(inputStreamAnimal);
