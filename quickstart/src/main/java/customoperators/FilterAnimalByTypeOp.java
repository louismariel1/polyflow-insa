...
public class FilterAnimalByTypeOp implements RelationToRelationOperator<AnimalBasket> {
    ...
    public FilterAnimalByTypeOp(String query, List<String> tvgNames, String resName){
        this.query = query;
